...
- Name: accessibility.spec.ts >> Accessibility >> should not have automatically detectable accessibility violations on landing page
...
- main [ref=e3]:
  ...
  - generic [ref=e8]:
    - heading "Ready when you are." [level=2] [ref=e9]
    - paragraph [ref=e10]: Use the fake catalog to rehearse the complete game without Spotify credentials.
    - button "Create demo game" [ref=e11] [cursor=pointer]
```
