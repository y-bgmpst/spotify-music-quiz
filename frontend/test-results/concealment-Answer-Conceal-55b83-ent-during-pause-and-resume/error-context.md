...
- Name: concealment.spec.ts >> Answer Concealment >> should maintain concealment during pause and resume
- Location: tests/e2e/concealment.spec.ts:89:3
...
Call log:
  - waiting for locator('button:has-text("Create demo game")')
...
- main [ref=f1e3]:
  - generic [ref=f1e4]:
    - text: 🏙️ FFM
    - generic [ref=f1e5]: 🎵 Spotify Music Quiz - 90s Edition 🎵
    - generic [ref=f1e6]:
      - button "Minimize" [ref=f1e7] [cursor=pointer]: _
      - button "Maximize" [ref=f1e8] [cursor=pointer]: □
      - button "Close" [ref=f1e9] [cursor=pointer]: ×
  - generic [ref=f1e11]:
    - paragraph [ref=f1e12]: ★ NETSCAPE NAVIGATOR 3.0 COMPATIBLE ★
    - heading "🎸 90s MUSIC QUIZ 🎸" [level=1] [ref=f1e13]
    - paragraph [ref=f1e14]:
      - generic [ref=f1e15]: ★ Welcome to the ultimate 90s music quiz experience! ★
    - group "⏱️ Quiz Time Limit" [ref=f1e16]:
      - generic [ref=f1e18]:
        - generic [ref=f1e19] [cursor=pointer]:
          - radio "5 Minutes (Fast & Furious!)" [checked] [ref=f1e20]
          - generic [ref=f1e21]: 5 Minutes (Fast & Furious!)
        - generic [ref=f1e22] [cursor=pointer]:
          - radio "10 Minutes (Chill Mode)" [ref=f1e23]
          - generic [ref=f1e24]: 10 Minutes (Chill Mode)
        - generic [ref=f1e25] [cursor=pointer]:
          - radio "No Limit (Unlimited Power!)" [ref=f1e26]
          - generic [ref=f1e27]: No Limit (Unlimited Power!)
    - button "🚀 START QUIZ 🚀" [ref=f1e29] [cursor=pointer]
    - paragraph [ref=f1e30]: Best viewed in 800×600 resolution • Made in Frankfurt am Main 🏙️
  - generic [ref=f1e31]:
    - generic [ref=f1e32]: 🏙️ Frankfurt Edition
    - generic [ref=f1e33]: Ready
    - generic [ref=f1e34]: 20:48:36
```
