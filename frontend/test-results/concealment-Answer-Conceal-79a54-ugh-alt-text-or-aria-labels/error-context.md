...
- Name: concealment.spec.ts >> Answer Concealment >> should not leak answer through alt text or aria labels
- Location: tests/e2e/concealment.spec.ts:70:3
...
- main [ref=e3]:
  - generic [ref=e4]:
    - generic [ref=e5]: 🎵 Spotify Music Quiz - 90s Edition 🎵
    - generic [ref=e6]:
      - button "Minimize" [ref=e7] [cursor=pointer]: _
      - button "Maximize" [ref=e8] [cursor=pointer]: □
      - button "Close" [ref=e9] [cursor=pointer]: ×
  - generic [ref=e11]:
    - paragraph [ref=e12]: ★ NETSCAPE NAVIGATOR 3.0 COMPATIBLE ★
    - heading "🎸 90s MUSIC QUIZ 🎸" [level=1] [ref=e13]
    - paragraph [ref=e14]:
      - generic [ref=e15]: ★ Welcome to the ultimate 90s music quiz experience! ★
    - group "⏱️ Quiz Time Limit" [ref=e16]:
      - generic [ref=e18]:
        - generic [ref=e19] [cursor=pointer]:
          - radio "5 Minutes (Fast & Furious!)" [checked] [ref=e20]
          - generic [ref=e21]: 5 Minutes (Fast & Furious!)
        - generic [ref=e22] [cursor=pointer]:
          - radio "10 Minutes (Chill Mode)" [ref=e23]
          - generic [ref=e24]: 10 Minutes (Chill Mode)
        - generic [ref=e25] [cursor=pointer]:
          - radio "No Limit (Unlimited Power!)" [ref=e26]
          - generic [ref=e27]: No Limit (Unlimited Power!)
    - button "🚀 START QUIZ 🚀" [ref=e29] [cursor=pointer]
    - paragraph [ref=e30]: Best viewed in 800×600 resolution • Now with FRAMES support!
  - generic [ref=e31]:
    - generic [ref=e32]: Ready
    - generic [ref=e33]: 20:47:49
```
